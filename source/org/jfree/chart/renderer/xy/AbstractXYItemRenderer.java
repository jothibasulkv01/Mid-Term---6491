...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
    ...
    public void drawDomainMarker(Graphics2D g2, XYPlot plot, 
        ...
        drawMarkerPoint(marker, domainAxis, plot, dataArea, g2, () -> plot.getDomainAxisEdge(),
						PlotOrientation.HORIZONTAL, PlotOrientation.VERTICAL,
						(PlotOrientation orientation, Line2D line,
								RectangleAnchor anchor) -> calculateDomainMarkerTextAnchorPoint(g2, orientation,
										dataArea, line.getBounds2D(), marker.getLabelOffset(),
    ...
    public void drawRangeMarker(Graphics2D g2, XYPlot plot, ValueAxis rangeAxis,
        ...
        drawMarkerPoint(marker, rangeAxis, plot, dataArea, g2, () -> plot.getRangeAxisEdge(),
	...
	private void drawMarkerPoint(Marker marker, ValueAxis domainAxis, XYPlot plot, Rectangle2D dataArea, Graphics2D g2,
		...
		if (marker instanceof ValueMarker) {
			...
			if (im.getOutlinePaint() != null && im.getOutlineStroke() != null) {
				if (orientation == arg2) {
					...
					Line2D line = line(dataArea, start, end, range, start2d, end2d);
					g2.setPaint(im.getOutlinePaint());
					g2.setStroke(im.getOutlineStroke());
					if (range.contains(start)) {
						g2.draw(line);
